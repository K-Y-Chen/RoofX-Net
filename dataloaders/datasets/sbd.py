...
class SBDSegmentation(data.Dataset):
    ...
    def __init__(self,
        ...
        self._cat_dir = os.path.join(self._dataset_dir, 'cls_png')
...
if __name__ == '__main__':
    ...
    trainset = SBDSegmentation(args, split='train')

    dataloader = DataLoader(trainset, batch_size=2, shuffle=True, num_workers=2)
