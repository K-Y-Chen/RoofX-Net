...
from .MSLNet.DCNV2 import DeformableConv2d
from .MSLNet.MobileNetV2 import mobilenetv2_xbn
import warnings
...
class MSLNet(nn.Module):
    def __init__(self, num_classes=4, backbone="mobilenetv2_xbn", pretrained=False, downsample_factor=8, Use_DCN=True):
