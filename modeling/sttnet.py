...
class STTNet(nn.Module):
    def __init__(self,  **kwargs):
        ...
        self.predict_head_out = nn.Sequential(
            ...
            nn.LeakyReLU(),
            nn.Conv2d(in_channels=last_channels * scale_factor, out_channels=self.n_classes, kernel_size=3, stride=1, padding=1),
        )
        ...
        self.loss_att_branch = nn.Sequential(
            ...
            nn.BatchNorm2d(64),
            nn.LeakyReLU(),
            nn.Conv2d(in_channels=64, out_channels=self.n_classes, kernel_size=3, stride=1, padding=1),
        )
