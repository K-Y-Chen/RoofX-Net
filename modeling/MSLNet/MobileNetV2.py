...
def mobilenetv2_xbn(pretrained=False, **kwargs):
    model = MobileNetV2_XBN(n_class=1000, **kwargs)
    if pretrained:
        model.load_state_dict(torch.load('./model_data/MSLNet_mobilenetv2.pth'))
    return model

if __name__ == "__main__":
    model = mobilenetv2_xbn()
